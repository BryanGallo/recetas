...
@endsection
@section('content')
    <h2 class="text-center mb-5 ">Editar la receta: {{ $receta->nombre }}</h2>
            ...
            <form method="POST" action={{ route('recetas.update',['receta'=>$receta->id]) }} enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror"
                        placeholder="nombre" value="{{ $receta->nombre }}">
                    @error('nombre')
                ...
                <div class="form-group">
                    ...
                    <input name="ingredientes" class="form-control @error('ingredientes') is-invalid @enderror"
                        placeholder="ingredientes" value="{{ $receta->ingredientes }}" type="hidden" id="ingredientes">
                ...
                <div class="form-group">
                    ...
                    <input name="preparacion" class="form-control @error('preparacion') is-invalid @enderror"
                        value="{{ $receta->preparacion }}" type="hidden" id="preparacion">
                ...
                <div class="form-group">
                    ...
                    <div class="mt-4">
                        <p>Imagen Actual</p>
                        <img src="/storage/{{$receta->imagen}}" alt="Imagen"
